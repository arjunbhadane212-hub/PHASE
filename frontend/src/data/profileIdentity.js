...
export const STREAK_TIERS = [
  { min: 100, key: 'incandescent', label: 'INCANDESCENT', a: '#FBBF24', b: '#FFFFFF', glow: 1.0 },
  { min: 30,  key: 'gold',         label: 'GOLD',         a: '#FBBF24', b: '#FDE68A', glow: 0.8 },
  { min: 7,   key: 'amber',        label: 'AMBER',        a: '#F59E0B', b: '#FCD34D', glow: 0.55 },
  { min: 1,   key: 'ember',        label: 'EMBER',        a: '#F97316', b: '#FDBA74', glow: 0.35 },
  { min: 0,   key: 'cold',         label: 'COLD',         a: '#6B7280', b: '#9CA3AF', glow: 0.0 },
];
...
// ── Titles ────────────────────────────────────────────────────────────────
// `style` comes from shop_items.rarity_style, set from the box a title can
// drop from. Shared titles (Overkill/Vermin/Relentless) resolve to their
// highest box, so a Phase pull never renders in Delta chrome.
export const TITLE_STYLES = {
  starter: { className: 'title-style-starter', a: '#9AA4B2', b: '#C7CDD6', glow: 0.2,  label: 'Starter', sheen: false, halo: false },
  delta:   { className: 'title-style-delta',   a: '#3B82F6', b: '#7FB4F5', glow: 0.55, label: 'Delta',   sheen: false, halo: false },
  phase:   { className: 'title-style-phase',   a: '#FBBF24', b: '#60A5FA', glow: 1.0,  label: 'Phase',   sheen: true,  halo: true  },
};
